...
import { FaLock, FaHome, FaEnvelope, FaCross } from "react-icons/fa";
import { motion } from "framer-motion";
import { CroissantIcon, Home, X, XCircleIcon } from "lucide-react";
      ...
      >
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-6 text-white">
          <div className="flex justify-center mb-4">
            <XCircleIcon className="text-5xl animate-pulse" />
          </div>
          <h1 className="text-3xl font-bold">Error 404</h1>
          <p className="mt-2 opacity-90">
            Ooops! The page you're looking for is not on this server.
          </p>
        </div>
